...
if __name__ == "__main__":
    ...
    avg_pol_scenario: NFSPScenario = scenario_catalog.get(
        scenario_name="loss_game_nfsp_10_moves_alpha_2.9"
    )
    ...
    player_0_avg_pol_spec = StrategySpec.from_json_file(
        "/home/jblanier/git/rlapps/rlapps/data/loss_game_nfsp_10_moves_alpha_2.9_sparse_12.07.15AM_May-18-202120bfveou/avg_policy_checkpoint_specs/average_policy_player_0_iter_30000.json"
    )
    ...
    tune.run(
        ...
        mode="max",
        local_dir=data_dir(),
        stop={"timesteps_total": int(600e3)},
        loggers=[
