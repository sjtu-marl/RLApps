...
from rlapps.envs.oshi_zumo_multi_agent_env import TinyOshiZumoMultiAgentEnv
...
if __name__ == "__main__":
    ...
    experiment_name = f"tiny_oshi_zumo_hyper_param_search_dqn"
    num_cpus = 60
    num_gpus = 0
    ...
    player_0_avg_pol_spec = StrategySpec.from_json_file(
        "/home/jblanier/git/rlapps/rlapps/data/oshi_zumo_tiny_nfsp_dqn_sparse_01.54.50PM_Apr-08-20218z_hf4wq/avg_policy_checkpoint_specs/average_policy_player_0_iter_214000.json"
    )
