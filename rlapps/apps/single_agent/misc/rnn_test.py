...
from rlapps.envs.rnn_test_env import RNNTestMultiAgentEnv
from rlapps.utils.common import data_dir, datetime_str
from rlapps.apps.scenarios.trainer_configs.mutigrid_psro_configs import (
    psro_multigrid_ppo_params,
)
...
if __name__ == "__main__":
    ...
    policy_classes = {"best_response": PPOTorchPolicy}
