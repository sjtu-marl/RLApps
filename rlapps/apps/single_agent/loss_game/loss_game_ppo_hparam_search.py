...
if __name__ == "__main__":
    tmp_br_env = LossGameAlphaMultiAgentEnv(
        env_config={
            "total_moves": 10,
            "alpha": 2.9,
        }
    ...
    payoff_table_path = "/home/jblanier/git/rlapps/rlapps/data/loss_game_psro_10_moves_alpha_2.9/manager_12.17.29AM_May-18-2021/payoff_table_checkpoints/payoff_table_checkpoint_20.json"
        ...
        def on_episode_start(
            ...
            **kwargs,
            ...
            load_pure_strat(
                ...
                pure_strat_spec=opponent_policy_distribution.sample_policy_spec(),
            )
