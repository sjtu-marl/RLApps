...
from rlapps.envs.oshi_zumo_multi_agent_env import MediumOshiZumoMultiAgentEnv
...
if __name__ == "__main__":
    ...
    experiment_name = f"medium_oshi_zumo_hyper_param_search_dqn"
    num_cpus = 60
    num_gpus = 0
    ...
    avg_pol_scenario: NFSPScenario = scenario_catalog.get(
        scenario_name="oshi_zumo_tiny_nfsp_dqn"
    )
    ...
    player_0_avg_pol_spec = StrategySpec.from_json_file(
        "/home/jblanier/git/rlapps/rlapps/data/oshi_zumo_medium_nfsp_dqn_sparse_01.55.05PM_Apr-08-2021ta6arraq/avg_policy_checkpoint_specs/average_policy_player_0_iter_221000.json"
    )
