...
def _get_dist_class(
    config: TrainerConfigDict, action_space: gym.spaces.Space
    ...
    if isinstance(action_space, Discrete):
        ...
        # (JB) always squash actions!
        return (
            TorchSquashedGaussian if not config["_use_beta_distribution"] else TorchBeta
        )
