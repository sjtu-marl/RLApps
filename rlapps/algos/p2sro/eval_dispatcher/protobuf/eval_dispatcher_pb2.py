...
_EVALJOB = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="EvalJob.json_policy_specs_for_each_player",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="required_games_to_play",
            full_name="EvalJob.required_games_to_play",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_EVALJOBRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="json_policy_specs_for_each_player",
            full_name="EvalJobResult.json_policy_specs_for_each_player",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="EvalJobResult.payoffs_for_each_player",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="games_played",
            full_name="EvalJobResult.games_played",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_EVALCONFIRMATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="result",
            full_name="EvalConfirmation.result",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
EvalJob = _reflection.GeneratedProtocolMessageType(
    "EvalJob",
    (_message.Message,),
    {
        "DESCRIPTOR": _EVALJOB,
...
EvalJobResult = _reflection.GeneratedProtocolMessageType(
    "EvalJobResult",
    (_message.Message,),
    {
...
EvalConfirmation = _reflection.GeneratedProtocolMessageType(
    "EvalConfirmation",
    (_message.Message,),
    {
