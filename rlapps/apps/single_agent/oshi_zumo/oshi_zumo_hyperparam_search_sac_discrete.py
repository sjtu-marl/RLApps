...
from rlapps.rllib_tools.modified_policies.sac_torch_policy_squashed import (
    SACTorchPolicySquashed,
)
...
if __name__ == "__main__":
    ...
    experiment_name = f"oshi_zumo_hyper_param_search_sac_discrete"
    num_cpus = 60
    num_gpus = 0
    ...
    env_config = {
        ...
        "continuous_action_space": False,
        "illegal_actions_default_to_max_coin_value": True,
    ...
    hyperparams = {
        ...
        "target_entropy": choice(
            [None, -0.5 * tmp_env.action_space.n, -0.25 * tmp_env.action_space.n]
        ),
